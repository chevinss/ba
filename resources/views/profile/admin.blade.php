    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('update.admin') }}" method="post" id="updateAdmin">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-md btn-warning" onclick="document.getElementById('updateAdmin').submit();">Update Profile</button>
                </div>
            </div>
        </div>
    </div>
